...
exports.seedGameData = functions.region('us-central1').https.onCall(async (data, context) => {
  ...
  // You might want to check if user is admin, but for now assume authenticated user can seed
  ...
  try {
    ...
    throw new functions.https.HttpsError('internal', 'Failed to seed game data');
  }
});