...
// remain re-exported here, while the deployed trigger is replaced by the transactional writer.
export {
...
export { onStudentProgressReadModelWrite } from './childCourseProgressProjectionTransactional';
