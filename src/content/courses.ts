...
const GRAMMAR_BASIC_STAGES = [
  { title: 'Stage 1 — Sentence Foundations', start: 1, end: 6, focus: 'Build simple sentences with nouns and verbs.' },
  { title: 'Stage 2 — Meaning Builders', start: 7, end: 12, focus: 'Add meaning using adjectives, articles, and pronouns.' },
  { title: 'Stage 3 — Where/When/How', start: 13, end: 18, focus: 'Use prepositions and adverbs to add detail.' },
  { title: 'Stage 4 — Longer Sentences', start: 19, end: 24, focus: 'Join ideas and use plurals correctly.' },
  { title: 'Stage 5 — Asking + Punctuation', start: 25, end: 30, focus: 'Ask questions and punctuate sentences.' },
  { title: 'Stage 6 — Tenses Basics', start: 31, end: 36, focus: 'Use past, present, and future in simple sentences.' },
];
