...
const post: BlogPost = {
  ...
  body: [
    ...
    { type: 'li', content: 'Connect a printed letter or letter pattern with its sound.' },
    { type: 'li', content: 'Track the sounds from left to right without losing or changing their order.' },
    { type: 'li', content: 'Blend the sounds smoothly enough to recognise the whole spoken word.' },
    { type: 'li', content: 'Repeat the process on a fresh word instead of depending on memory, pictures or adult prompts.' },
    { type: 'p', content: 'A weakness at any one point can look like “my child knows sounds but cannot read.” This is why adding more letter-sound flashcards is not always the right next step.' },
    ...
    { type: 'p', content: 'Use a word the child has not just practised. If familiar words are read easily but new words cause guessing, the child may be recalling whole word shapes rather than applying a transferable decoding process.' },
    { type: 'h3', content: '5. Sentence transfer check' },
    ...
    { type: 'li', content: 'Do not respond to a blending gap by teaching dozens of new sounds at once.' },
    { type: 'li', content: 'Do not ask the child to use the picture or first letter to guess the whole word.' },
    { type: 'li', content: 'Do not repeat the answer so quickly that the child never gets a chance to complete the blend.' },
    { type: 'li', content: 'Do not make text harder just because the child can recite more phonics rules.' },
    { type: 'li', content: 'Do not measure progress only by the number of words memorised.' },

    { type: 'h2', content: 'What real progress looks like' },
    { type: 'p', content: 'Useful progress is observable. The child begins a word with less prompting, keeps sounds in the correct order, makes fewer picture-based guesses, retries after an error, and reads an unfamiliar word built from known patterns. Later, the same decoding behaviour starts to appear inside sentences and short passages.' },
    { type: 'p', content: 'Progress is not perfectly linear. New spelling patterns, longer words and harder text can temporarily reduce speed. The key question is whether the underlying strategy is becoming more independent and transferable.' },

    { type: 'h2', content: 'What a good phonics class should do with this problem' },
    { type: 'li', content: 'Check the child’s current sound knowledge rather than assume it from age or school grade.' },
    { type: 'li', content: 'Test oral and printed blending separately.' },
    { type: 'li', content: 'Use decodable examples that match taught patterns.' },
    { type: 'li', content: 'Correct errors live, let the child retry, and revisit the same pattern later.' },
    { type: 'li', content: 'Show parents evidence from unfamiliar-word reading, not only completed worksheets.' },
  ...
  faq: [
    ...
    { question: 'Should I teach more letter sounds first?', answer: 'Not automatically. If the child already recalls the required sounds, practise blending those known sounds into simple words before increasing the pattern load.' },
    { question: 'Is memorising sight words a solution?', answer: 'A small number of high-frequency irregular words may need special attention, but memorising whole word lists does not replace a transferable decoding process for regular unfamiliar words.' },
    { question: 'How can I tell whether my child is guessing?', answer: 'Use an unfamiliar decodable word with no picture clue. If the child relies on the first letter, context or a memorised word shape instead of moving through the sounds, guessing is probably part of the reading strategy.' },
    { question: 'What is the most useful progress check?', answer: 'Ask the child to decode an appropriate word they have not just practised. Independent transfer to fresh examples is stronger evidence than repeating a familiar list.' },
    { question: 'When should I ask for extra support?', answer: 'Seek a closer review when the child is not becoming more independent despite consistent, stage-matched instruction and practice, or when broader speech, language, hearing or learning concerns are also present.' },
  ],
};
