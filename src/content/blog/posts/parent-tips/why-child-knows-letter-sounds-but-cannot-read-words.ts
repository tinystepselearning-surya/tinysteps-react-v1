...
const post: BlogPost = {
  ...
  title: 'Why Does My Child Know Letter Sounds But Cannot Read Words?',
  ...
  body: [
    ...
    { type: 'h3', content: 'Stage 2 — Oral blend' },
    ...
    { type: 'h3', content: '1. The child knows the sounds but cannot merge them orally' },
    { type: 'p', content: 'Blending is a separate skill from naming individual phonemes. If /s/ /u/ /n/ never becomes **sun** without print, strengthen oral sound merging before making the written task harder.' },

    { type: 'h3', content: '2. The sounds are produced too separately' },
    { type: 'p', content: 'A pattern such as /c/ … /a/ … /t/ with long pauses can make the first sound difficult to hold while the child reaches the last. Where the sounds allow it, smoother or continuous blending can make the sequence easier to maintain.' },

    { type: 'h3', content: '3. Extra “uh” sounds are being added' },
    { type: 'p', content: 'If /m/ becomes “muh” or /t/ becomes “tuh”, the child is trying to combine extra sounds that are not present in the word. IES guidance specifically notes the importance of clear consonant pronunciation and avoiding schwa-like additions where possible because clean sound production supports blending.' },

    { type: 'h3', content: '4. The child is trying to guess after the first sound' },
    { type: 'p', content: 'Pictures and context help children understand stories, but they should not replace decoding when the task is to read an unfamiliar word. DfE parent guidance tells families to encourage children to sound out unfamiliar words and blend left to right rather than use pictures to guess.' },

    { type: 'h3', content: '5. The words contain patterns the child has not been taught' },
    { type: 'p', content: 'A child cannot fairly demonstrate blending if every practice word contains unfamiliar digraphs, vowel patterns or exception spellings. Match the word set to the child’s current phonics knowledge. Difficulty caused by untaught code is different from difficulty blending known code.' },

    { type: 'h3', content: '6. Familiar-word success is hiding weak transfer' },
    { type: 'p', content: 'Children can become very quick with a repeated set of words. That is useful practice, but it should be followed by a fresh matched example. Automatic recognition of familiar words and the ability to decode an unfamiliar word are related but not identical pieces of reading development.' },
    ...
    { type: 'li', content: '“Start at the left. What sound does this part represent?”' },
    { type: 'li', content: '“Keep those sounds together and move to the next one.”' },
    { type: 'li', content: '“Blend it again. What word did you make?”' },
    { type: 'li', content: '“Now try this new word using the same pattern.”' },
    { type: 'p', content: 'The aim is gradual independence. If every word still requires the complete adult model, the practice level may be too difficult or the earlier stage needs more teaching.' },

    { type: 'h2', content: 'What parents should avoid' },
    { type: 'li', content: 'Do not respond to a blending gap by teaching many new letter sounds at once.' },
    { type: 'li', content: 'Do not ask the child to guess the whole word from its picture, first letter or sentence context.' },
    { type: 'li', content: 'Do not supply the answer so quickly that the child never completes the blend.' },
    { type: 'li', content: 'Do not make the text harder simply because the child can recite more phonics rules.' },
    { type: 'li', content: 'Do not count familiar memorised words as the only evidence of reading progress.' },
    { type: 'li', content: 'Do not assume a persistent decoding difficulty automatically means dyslexia or another diagnosis.' },

    { type: 'h2', content: 'What progress should look like' },
    { type: 'p', content: 'Useful progress is not “my child learned 20 more sounds.” For this diagnostic, watch the **reading process**.' },
    ...
    { type: 'p', content: 'If single-word decoding is already accurate and the main problem is pace or expression, use the fluency guide instead. If word reading is accurate but meaning is weak, use the comprehension guide instead. Correct diagnosis prevents a child from being sent back to beginner phonics unnecessarily.' },

    { type: 'h2', content: 'When to ask for a closer review' },
    { type: 'p', content: 'Talk with the child’s teacher and consider an appropriate qualified professional when decoding is persistently difficult despite explicit, stage-matched instruction and practice, or when there are broader concerns involving speech-sound awareness, spoken language, hearing, memory or learning. One difficulty with blending is not enough to diagnose a condition.' },
    { type: 'p', content: 'If the child reads much more successfully in class than at home, also compare the text and prompting conditions using [Why Can My Child Read in Class but Struggle at Home?](/blog/child-reads-in-class-but-forgets-at-home).' },

    { type: 'h2', content: 'Evidence and references' },
    { type: 'li', content: '[Education Endowment Foundation — Phonics](https://educationendowmentfoundation.org.uk/education-evidence/teaching-learning-toolkit/phonics)' },
    ...
    { type: 'li', content: '[IES — Foundational Reading Practice Guide PDF](https://ies.ed.gov/ncee/wwc/Docs/PracticeGuide/wwc_foundationalreading_040717.pdf)' },
    { type: 'li', content: '[IES — Supporting Your Child’s Reading at Home](https://ies.ed.gov/use-work/resource-library/resource/other-resource/supporting-your-childs-reading-home)' },
    ...
    { type: 'li', content: '[UK Department for Education — The Reading Framework](https://www.gov.uk/government/publications/the-reading-framework-teaching-the-foundations-of-literacy)' },
    { type: 'li', content: '[UK Department for Education — Systematic Synthetic Phonics Programme Validation Supporting Documentation](https://www.gov.uk/government/publications/phonics-teaching-materials-core-criteria-and-self-assessment/validation-of-systematic-synthetic-phonics-programmes-supporting-documentation)' },
    { type: 'li', content: '[UK Department for Education — Phonics Screening Check: Information for Parents](https://www.gov.uk/government/publications/phonics-screening-check-information-for-parents/phonics-screening-check-2024-information-for-parents-text-only-version)' },
    { type: 'li', content: '[UK Department for Education — National Curriculum in England: English Programmes of Study](https://www.gov.uk/government/publications/national-curriculum-in-england-english-programmes-of-study/national-curriculum-in-england-english-programmes-of-study)' },
    { type: 'li', content: '[UFLI — Phoneme–Grapheme Mapping](https://ufli.education.ufl.edu/resources/teaching-resources/instructional-activities/phoneme-grapheme-mapping/)' },
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Not automatically. If the sounds needed for the word are already secure, adding more sounds increases the load without repairing the blending step. Practise combining a small known set first.',
    },
    {
      question: 'How can I tell whether my child is decoding or memorising words?',
      answer: 'Use a fresh decodable word built from sound-spelling patterns the child already knows. Independent reading of that new word is stronger evidence of transfer than repeating a familiar word list.',
    },
    {
      question: 'Should my child use pictures to guess a word when blending is hard?',
      answer: 'Pictures are useful for story meaning, but they should not replace decoding an unfamiliar word. For word reading, guide the child through the known grapheme–phoneme correspondences from left to right and then discuss meaning after the word is read.',
    },
    {
      question: 'When should I get extra help if my child knows sounds but still cannot read?',
      answer: 'Ask for a closer review when decoding remains persistently difficult despite explicit, stage-matched teaching and practice, or when broader speech, language, hearing or learning concerns are present. A blending difficulty by itself is not a diagnosis.',
    },
  ],
};
