...
/**
 * Public-facing replacements for the original editorial week-number slugs.
 *
 * Source filenames and source slugs intentionally remain as internal editorial
 * history. The public blog registry exposes the evergreen slug/title below.
 * Old public URLs are preserved separately as permanent redirects.
 */
export const LEGACY_WEEK_BLOG_RENAMES: Readonly<Record<string, LegacyWeekBlogRename>> = Object.freeze({
...
const PUBLIC_PATH_RENAMES = Object.freeze(
  Object.fromEntries(
...
export function rewriteLegacyWeekBlogPaths(value: string): string {
  ...
  for (const [source, destination] of Object.entries(PUBLIC_PATH_RENAMES)) {
