 ...
 * Level decisions must be based on skills that have actually been taught and assessed.
 */
export const READING_LEVEL_DEFINITIONS: ReadingLevelDefinition[] = [
  { key: 'TS0', level: 0, shortLabel: 'Pre-reading', description: 'Builds listening, rhyme, oral blending and phonological awareness; independent print decoding is not yet demonstrated.' },
  ...
  { key: 'TS4', level: 4, shortLabel: 'Digraph decoding', description: 'Decodes words containing taught common digraphs and consolidates simple controlled sentence reading.' },
  ...
  { key: 'TS7', level: 7, shortLabel: 'Sentence reader', description: 'Reads instructionally aligned controlled sentences with improving accuracy, phrasing and automaticity.' },
  { key: 'TS8', level: 8, shortLabel: 'Passage reader', description: 'Reads instructionally appropriate controlled or decodable passages aligned to taught phonics with developing fluency and literal comprehension.' },
  { key: 'TS9', level: 9, shortLabel: 'Confident early reader', description: 'Applies taught phonics independently across connected text with established early-reading fluency and comprehension at the assessed instructional level.' },
];
...
export const READING_DOMAIN_DEFINITIONS: Array<{
  ...
  { key: 'connectedText', label: 'Connected-text reading', description: 'Accuracy and developing fluency when reading instructionally aligned controlled sentences or passages.' },
  { key: 'comprehension', label: 'Comprehension', description: 'Understanding text that the child can independently access at the assessed instructional level.' },
];
