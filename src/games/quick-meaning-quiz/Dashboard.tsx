...
export default function Dashboard() {
  // Force fresh computation with polling for real-time updates
  ...
  useEffect(() => {
    ...
    const handleStorageChange = (e: StorageEvent) => {
      if (e.key?.includes('quick-meaning-mastery') || e.key?.includes('quick-meaning-achievements')) {
        refreshData();
      }
    };
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-800 mb-2">
            ⏱️ Quick Meaning Progress
          </h1>
          <p className="text-slate-600 text-base sm:text-lg">
            Track your quiz mastery across all words
          </p>
        </div>
