...
export const gameMeta = {
  ...
  description: "Pop balloons with IPA phonemes! Learn English sounds through fun, adaptive gameplay.",
  tags: ["ipa", "phonetics", "phonemes", "listening", "balloons"],
  icon: "🎈",
};
