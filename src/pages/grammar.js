...
export default function GrammarPage() {
    return (_jsxs("div", { children: [_jsx(ProgramHero, { program: "Grammar", title: "Grammar & Writing Lab", subtitle: "Playful grammar drills + AI writing coach ensure kids write clearly and confidently.", badges: ['Ages 5–15', 'Live feedback', 'Weekly writing samples'], highlights: [
