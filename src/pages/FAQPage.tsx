...
const items: FAQItem[] = [
  ...
  { id: 'q21', category: 'summer', question: 'What is Summer English Camp 2026?', answer: 'An intensive 10-week live summer program (April 1–June 15, 2026) combining phonics, grammar, and public speaking. Group classes are the default, with a premium 1:1 option. Designed for ages 3–12 to build English foundations fast.' },
  { id: 'q22', category: 'summer', question: 'What ages is the camp for?', answer: 'Ages 3–12. We split into cohorts: Tiny Explorers (3–5), Foundation (5–7), Intermediate (7–10), Advanced (10–12). Each learns at their level.' },
  ...
  { id: 'q24', category: 'summer', question: 'Is summer camp 1:1 or group?', answer: 'Group classes are the default for motivation and affordability, with a premium 1:1 option for faster personalization. Check <a href="/summer-english-camp-2026" class="text-tiny-green-600">camp details page</a> for the latest options.' },
  { id: 'q25', category: 'summer', question: 'When is the camp and what are the fees?', answer: 'Camp runs April 1–June 15, 2026 (10 weeks). Fees follow our standard group and premium 1:1 pricing. <a href="/summer-english-camp-2026" class="text-tiny-green-600">Visit the camp page</a> or <a href="/contact" class="text-tiny-blue-600">contact us</a> for details.' },
  ...
  { id: 'q27', category: 'pricing', question: 'What class packages do you offer?', answer: 'Flexible packages: 1, 4, 8, 12, or 24 classes. Buy as you go (per-class rate) or subscribe for longer commitment (better rate). All include stage-based progress updates. See <a href="/pricing" class="text-tiny-green-600">pricing page</a> for details.' },
