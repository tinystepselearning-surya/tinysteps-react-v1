...
const items: FAQItem[] = [
  ...
  { id: 'q21', category: 'summer', question: 'What is Summer English Camp 2026?', answer: 'An intensive 7-week live summer program (June–July 2026) combining phonics, grammar, and public speaking. 1:1 instruction with daily practice, games, and a capstone performance video. Designed for ages 3–12 to build English foundations fast.' },
