...
const items: FAQItem[] = [
  ...
  { id: 'q21', category: 'summer', question: 'What is Summer English Camp 2026?', answer: 'A 10-week live summer brush-up program (April 1–June 15, 2026) combining phonics, grammar, and public speaking for ages 4–12. It follows the same Tiny Steps curriculum in a focused group format.' },
  ...
  { id: 'q24', category: 'summer', question: 'Is summer camp group-based?', answer: 'Yes. Summer camp is group-focused with small live batches. Check the <a href="/summer-camps#programs" class="text-tiny-green-600">summer camps page</a> for the latest batch options.' },
  { id: 'q25', category: 'summer', question: 'When is the camp and what are the fees?', answer: 'Camp runs April 1–June 15, 2026 (10 weeks). Summer Camp Fast Track Pack enrollment is ₹2,400 per child (70% off from ₹8,000). <a href="/summer-camps" class="text-tiny-green-600">Visit the summer camps page</a> for details.' },
