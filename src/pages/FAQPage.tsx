...
const items: FAQItem[] = [
  ...
  { id: 'q21', category: 'summer', question: 'What is Summer English Camp 2026?', answer: 'An intensive 10-week live summer program (April 1–June 15, 2026) combining phonics, grammar, and public speaking. Group classes are the default, with Standard and Ultra Premium teaching options. Designed for ages 3–12 to build English foundations fast.' },
  ...
  { id: 'q24', category: 'summer', question: 'Is summer camp 1:1 or group?', answer: 'Group classes are the default for motivation and affordability, with 1:1 options for faster personalization. Check <a href="/summer-english-camp-2026" class="text-tiny-green-600">camp details page</a> for the latest options.' },
  { id: 'q25', category: 'summer', question: 'When is the camp and what are the fees?', answer: 'Camp runs April 1–June 15, 2026 (10 weeks). Fees follow Tiny Steps Standard (classes with expert Indian teachers) and Tiny Steps Ultra Premium (classes with native English-speaking teachers). <a href="/summer-english-camp-2026" class="text-tiny-green-600">Visit the camp page</a> or <a href="/contact" class="text-tiny-blue-600">contact us</a> for details.' },
