...
const JOURNEY_STOPS: JourneyStop[] = [
  ...
  { key: "S4", title: "Sentence Reading (Decoding, Fluency & Meaning)", category: "phonics" },
  { key: "S5", title: "Sentence Writing (Handwriting & Punctuation)", category: "grammar" },
  { key: "S6", title: "Spelling Patterns & Phonics Rules", category: "phonics" },
  { key: "S7", title: "Grammar & Vocabulary", category: "grammar" },
  { key: "S8", title: "Confident Speaking (No Stage Fright)", category: "speaking" },
];
    ...
    () => {
      ...
      const journeyDetails: Record<string, any> = {
        S1: {
          ...
          category: "phonics",
          childCanDo: ["Hold the pencil with better control", "Trace lines and curves with confidence", "Keep hand movements steady and neat"],
          nextMilestone: "Begin forming first letters with correct direction",
          teacherFocus: ["Pencil grip", "Line control", "Hand strength and confidence"],
          homePractice: "Trace big curves, lines, and simple shapes for 5 minutes",
          parentUpdateExample: "Grip and control are improving well—short tracing practice at home will lock this in.",
        },
        S2: {
          key: "S2",
          title: "Letter–Sound Correspondence & Letter Formation",
          category: "phonics",
          childCanDo: ["Recognize and say common letter sounds", "Form simple letters with better control", "Match sounds to letters with support"],
          nextMilestone: "Blend 2–3 sounds into simple words",
          teacherFocus: ["Sound accuracy", "Letter formation", "Sound-symbol connection"],
          homePractice: "Point to letters and say their sounds, then trace 3–4 letters",
          parentUpdateExample: "Sound-symbol links are clicking—daily 5-letter sound review will accelerate blending.",
        },
        S3: {
          key: "S3",
          title: "Blending & Word Families",
          category: "phonics",
          childCanDo: ["Blend sounds into simple words", "Read common CVC and word-family words", "Hear beginning, middle, and ending sounds"],
          nextMilestone: "Read short phrases and simple sentences smoothly",
          teacherFocus: ["Blending fluency", "Word family patterns", "Segmenting and spelling sounds"],
          homePractice: "Read 5 simple CVC or word-family words and spell 2 aloud",
          parentUpdateExample: "Blending is becoming automatic—word-family practice is now strengthening reading speed.",
        },
        S4: {
          key: "S4",
          title: "Sentence Reading (Decoding, Fluency & Meaning)",
          category: "phonics",
          childCanDo: ["Read short sentences with better flow", "Pause at full stops", "Answer simple meaning-based questions"],
          nextMilestone: "Write simple sentences independently",
          teacherFocus: ["Decoding fluency", "Expression and pausing", "Meaning and comprehension"],
          homePractice: "Read a 3-sentence passage and ask “What happened?”",
          parentUpdateExample: "Sentence reading is stronger now—retell checks are improving understanding too.",
        },
        S5: {
          key: "S5",
          title: "Sentence Writing (Handwriting & Punctuation)",
          category: "grammar",
          childCanDo: ["Write simple sentences clearly", "Use capital letters and full stops", "Leave proper spacing between words"],
          nextMilestone: "Write 3–4 connected sentences on one idea",
          teacherFocus: ["Sentence structure", "Capitals and punctuation", "Writing confidence and clarity"],
          homePractice: "Write 3 simple sentences about the day, toy, or picture",
          parentUpdateExample: "Independent sentence writing has started—clarity and punctuation are becoming consistent.",
        },
        S6: {
          key: "S6",
          title: "Spelling Patterns & Phonics Rules",
          category: "phonics",
          childCanDo: ["Notice common spelling patterns", "Apply simple phonics rules in reading and spelling", "Spell longer words with support"],
          nextMilestone: "Use patterns confidently in reading and writing",
          teacherFocus: ["Pattern recognition", "Rule application", "Word structure"],
          homePractice: "Find and read words with one target pattern like ai, ee, oa, or magic e",
          parentUpdateExample: "Pattern-based spelling is improving—your child is now using rules, not guessing.",
        },
        S7: {
          key: "S7",
          title: "Grammar & Vocabulary",
          category: "grammar",
          childCanDo: ["Use better sentence patterns", "Choose stronger everyday vocabulary", "Build clearer and longer responses"],
          nextMilestone: "Write short paragraphs with more variety and detail",
          teacherFocus: ["Grammar accuracy", "Vocabulary expansion", "Sentence variety"],
          homePractice: "Make 3 sentences using one target word or one grammar pattern",
          parentUpdateExample: "Grammar and word choice are maturing—ideas are now clearer and more connected.",
        },
        S8: {
          key: "S8",
          title: "Confident Speaking (No Stage Fright)",
          category: "speaking",
          childCanDo: ["Speak clearly in front of others", "Share ideas in full sentences", "Speak with more confidence and expression"],
          nextMilestone: "Present a short 1–2 minute talk with calm delivery",
          teacherFocus: ["Speaking confidence", "Voice and expression", "Organizing ideas for presentation"],
          homePractice: "Speak for 1 minute on a familiar topic like “My day” or “My favourite thing”",
          parentUpdateExample: "Confidence is visible—your child now shares ideas clearly in front of others.",
        },
      };
