...
const faqItems = [
  { question: 'Is the Summer Reading Program 2026 still open?', answer: `No. ${SUMMER_CAMP_2026_ARCHIVE_LABEL} This page is retained as an evergreen reading-support guide.` },
  ...
  return (
    <main className="container mx-auto max-w-5xl px-6 py-12">
      <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm font-semibold text-amber-900">
        {SUMMER_CAMP_2026_ARCHIVE_LABEL} This page is a reading-planning resource, not an active summer enrollment page.
      </div>
      ...
      <section className="mt-10 rounded-3xl bg-slate-900 p-7 text-white">
        ...
        <p className="mt-3 text-slate-200">The 2026 seasonal programme is closed. Use the year-round reading or phonics pathway based on the child’s current bottleneck.</p>
      ...
      <p className="mt-8 text-sm text-slate-500">Historical context: Tiny Steps Summer Camp 2026 ran from {summer.startDateLabel} to {summer.endDateLabel}.</p>
