		...
		<div className="container mx-auto max-w-4xl px-6 py-12">
			<section className="mb-12 text-center">
				...
				<p className="mt-4 text-lg text-slate-700">
					Tiny Steps live spoken English classes help children move from
			...
			<section className="mb-10 rounded-xl border border-amber-100 bg-amber-50 p-6">
				<h2 className="mb-2 text-lg font-bold text-slate-900">
					What are spoken English classes for kids?
				</h2>
				<p className="text-slate-700">
					Spoken English classes for kids help children speak in clearer
			...
			<section className="mb-10 rounded-xl border border-slate-200 bg-white p-6">
				...
				<ul className="space-y-2 text-slate-700">
					...
					<li>
						• Child needs communication readiness for speeches and
						presentations.
					</li>
				</ul>
			</section>
			...
			<section className="mb-10 rounded-xl border border-amber-100 bg-amber-50 p-6">
				...
				<ul className="space-y-2 text-slate-700">
					<li>
						• Live speaking classes with guided correction and encouragement.
					</li>
					<li>
						• Structured progression from sentence speaking to short stage
						talks.
					</li>
					<li>
						• Age-appropriate activities for confidence, clarity, and
						vocabulary use.
					</li>
					<li>
						• Parent-visible progress through speaking milestones and
						feedback.
					</li>
					<li>
						• Trusted by 250+ families with 4.9/5 parent satisfaction and
				...
				<p className="mt-4 text-sm text-slate-700">
					...
					{' • '}
					<Link
						to="/confidence-building-program-kids"
						className="font-semibold underline underline-offset-2 hover:text-slate-900"
					>
			...
			<section className="rounded-xl bg-slate-900 p-8 text-center text-white">
				<p className="mb-3 text-sm text-slate-300">
					If your child is facing this, the next step is simple:
				</p>
				<h2 className="text-2xl font-bold">
					Ready to build speaking confidence?
				</h2>
				<p className="mt-2 text-slate-200">
					Book a free assessment to choose the right spoken-English starting
					point.
				</p>
				<Link
					to="/book-demo"
