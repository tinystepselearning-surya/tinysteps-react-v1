...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'It is best for early learners who are practising pre-writing strokes, capital letters, and small letters.'
  },
  {
...
export default function FreeLetterTracingGamePage() {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 pb-12 pt-2 sm:px-6 lg:px-8">
      <Meta
        title="Free Letter Tracing Game for Kids | Online Alphabet Tracing"
        description="Let your child practise lines, curves, capital letters, and small letters with a free online tracing game for kids. Start from the red dot and follow the guide."
        canonical={PAGE_URL}
      />
      ...
      <section className="mt-8 grid gap-4 sm:grid-cols-2">
        ...
        <article className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <ol className="mt-3 space-y-2 text-sm text-slate-700">
            <li>1. Start with warm-up shapes before letters.</li>
            <li>2. Ask your child to begin from the red dot and follow the guide.</li>
            <li>3. Keep sessions short and repeat daily for consistency.</li>
          </ol>
        </article>
      </section>
