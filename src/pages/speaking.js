...
export default function SpeakingPage() {
    return (_jsxs("div", { children: [_jsx(ProgramHero, { program: "Public Speaking", title: "Super Speakers Studio", subtitle: "From shy to spotlight-ready with live coaches, AI observation notes, and weekly showcase videos.", badges: ['Ages 4–15', 'S.P.E.A.K habit', 'Parent video notes'], highlights: [
