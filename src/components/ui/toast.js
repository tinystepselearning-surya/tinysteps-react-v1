...
const Toast = React.forwardRef((_a, ref) => {
    var { className, variant, description, action } = _a, props = __rest(_a, ["className", "variant", "description", "action"]);
    return (_jsxs(ToastPrimitives.Root, Object.assign({ ref: ref, className: cn(toastVariants({ variant }), className) }, props, { children: [props.children, description && (_jsx("div", { className: "text-sm text-muted-foreground", children: description })), action && _jsx("div", { className: "mt-2", children: action })] })));
});
