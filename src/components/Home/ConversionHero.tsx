...
const ConversionHero: React.FC = () => {
  return (
    <section data-animate="fade-up" className="relative overflow-hidden bg-[radial-gradient(circle_at_top,_#ffe6cc,_#fff8ec,_#dff2ff_70%)] py-20 md:py-28">
      <div className="pointer-events-none absolute inset-0 opacity-30">
        <div data-parallax data-parallax-speed="-0.2" className="absolute -left-16 top-6 h-48 w-48 rounded-full bg-[#ff9f43]/60 blur-3xl" />
        <div data-parallax data-parallax-speed="0.1" className="absolute right-8 top-16 h-56 w-56 rounded-full bg-[#66c4ff]/45 blur-3xl" />
        <div data-parallax data-parallax-speed="-0.05" className="absolute bottom-6 left-1/4 h-40 w-72 rounded-full bg-[#ffc857]/40 blur-3xl" />
        <div data-parallax data-parallax-speed="0.15" className="absolute top-1/2 left-0 h-24 w-24 rounded-full bg-[#8b5cf6]/25 blur-3xl" />
      </div>
        ...
        <div>
          ...
          >
            ...
            <span className="block bg-gradient-to-r from-[#ff8f5c] via-[#ffb347] to-[#59c3ff] bg-clip-text text-3xl text-transparent md:text-4xl">
              Bright-sky calm. Live mentors. AI-curated journeys.
            </span>
          </motion.h1>
          <motion.p
          ...
          <div className="rounded-[32px] bg-white/90 p-6 shadow-[0_20px_45px_rgba(255,143,92,0.25)]">
            ...
            <div className="mt-5 space-y-3 text-sm text-gray-600">
              <div className="flex items-center justify-between rounded-2xl bg-gray-50 px-4 py-3">
                ...
                <span className="text-xs text-gray-500">Personalised weekly plan</span>
              </div>
              <div className="flex items-center justify-between rounded-2xl bg-gray-50 px-4 py-3">
            ...
            <div className="mt-5 rounded-2xl border border-dashed border-gray-200 p-4 text-xs text-gray-600">
              Screen experience stays calm for parents and kids—clear blues, gentle gradients, and clean typography across every page.
            </div>
          </div>
        </div>
      </div>
