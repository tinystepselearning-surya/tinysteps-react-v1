...
const plans = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Ideal for fast catch-up or advanced learners',
    ],
    highlight: false,
  },
];
    ...
    <section className="bg-gradient-to-b from-slate-50 to-white py-20">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <p className="mx-auto mb-10 max-w-3xl text-center text-sm text-gray-600">
          Standard 1:1 fee:{' '}
          <span className="font-semibold">₹599 per 35-minute class</span>.
          Save with curated packs at effective rates between ₹500–₹550 per class.
        </p>
