...
const LearningJourneySection = () => {
    return (_jsx("section", { className: "bg-white py-20", children: _jsxs("div", { className: "mx-auto max-w-6xl px-6", children: [_jsx("div", { className: "mb-10 text-center", children: _jsx("h2", { className: "font-heading text-3xl font-bold md:text-4xl", children: "Your Child\\'s 3-Month Transformation" }) }), _jsxs("div", { className: "relative", children: [_jsx("div", { className: "absolute left-1/2 top-0 hidden h-full w-0.5 -translate-x-1/2 bg-gradient-to-b from-primary-500 to-secondary-500 md:block" }), _jsx("ol", { className: "space-y-10", children: steps.map((s, _i) => (_jsx("li", { className: "md:grid md:grid-cols-2 md:items-center md:gap-10", children: _jsxs(motion.div, { className: "rounded-3xl bg-white p-6 shadow-lg ring-1 ring-slate-200", initial: { opacity: 0, y: 16 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, amount: 0.2 }, transition: { duration: 0.4 }, children: [_jsx("h3", { className: "font-heading text-xl font-semibold text-gray-900", children: s.title }), _jsx("p", { className: "text-sm text-primary-600", children: s.duration }), _jsx("ul", { className: "mt-3 space-y-2 text-gray-700", children: s.body.map((b, idx) => (_jsxs("li", { children: ["\u2022 ", b] }, idx))) })] }) }, s.title))) })] })] }) }));
};
