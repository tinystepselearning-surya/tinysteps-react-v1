...
} from '../../../scripts/lib/teacher-progress-enrollment-audit.mjs';

const enrollment = (id: string, data: Record<string, unknown>) => ({ id, data });
const progress = (kidId: string, topicId: string, data: Record<string, unknown>) => ({
