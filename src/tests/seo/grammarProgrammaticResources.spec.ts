...
describe('Governed grammar programmatic resources', () => {
  it('publishes a bounded 15-page set inside a 21-step curriculum-aligned sequence', () => {
    expect(GRAMMAR_PROGRAMMATIC_SEQUENCE).toHaveLength(21);
    expect(GRAMMAR_PROGRAMMATIC_PAGES).toHaveLength(15);
    expect(GRAMMAR_PROGRAMMATIC_PATHS).toHaveLength(15);
