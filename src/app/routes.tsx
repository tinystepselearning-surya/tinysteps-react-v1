...
const Blend2LettersGame = lazy(() => import('../pages/kids/games/phonics/blend-builder/Blend2LettersGame'));
      ...
      children: [
        ...
        // ---------- Kids Portal (standalone, kid-friendly) ----------
        {
          ...
          children: [
            ...
            { path: 'games/phonics/blend-builder', element: <Blend2LettersGame /> },
