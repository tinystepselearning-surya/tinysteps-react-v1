  ...
  [
    ...
    { path: 'dev/comet-courier', element: <CometCourierGame /> },
    {
      ...
      children: [
        ...
        { path: 'courses/phonics-foundations', element: <Navigate to="/courses/phonics-foundation" replace /> },
        { path: 'courses/phonics', element: <Navigate to="/courses/phonics-foundation" replace /> },
        { path: 'courses/phonics/', element: <Navigate to="/courses/phonics-foundation" replace /> },
        { path: 'courses/grammar-essentials', element: <Navigate to="/courses/grammar" replace /> },
        ...
        { path: 'blog/week1', element: <Navigate to="/blog/week-1-phonics-satpin-launch" replace /> },
        { path: 'blog/week2', element: <Navigate to="/blog/week-2-phonics-blending-club" replace /> },
        { path: 'blog/week4', element: <Navigate to="/blog/week-4-phonics-long-vowels" replace /> },
        { path: 'blog/week5', element: <Navigate to="/blog/week-5-phonics-r-controlled" replace /> },
        ...
        { path: 'main/courses/phonics', element: <Navigate to="/courses/phonics-foundation" replace /> },
        { path: 'main/courses/phonics/', element: <Navigate to="/courses/phonics-foundation" replace /> },
        { path: 'main/courses/phonics-foundations', element: <Navigate to="/courses/phonics-foundation" replace /> },
        { path: 'main/courses/grammar', element: <Navigate to="/courses/grammar-mastery" replace /> },
        { path: 'main/courses/grammar/', element: <Navigate to="/courses/grammar-mastery" replace /> },
        { path: 'main/courses/public-speaking', element: <Navigate to="/courses/public-speaking-foundations" replace /> },
        { path: 'main/courses/public-speaking/', element: <Navigate to="/courses/public-speaking-foundations" replace /> },
