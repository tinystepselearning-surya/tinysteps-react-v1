...
const Layout = () => (_jsxs("div", { className: "min-h-screen bg-[radial-gradient(circle_at_top,_#fdf4ff,_#f4f8ff_45%,_#ffffff_80%)]", children: [_jsx(AnalyticsTracker, {}), _jsx(ScrollToTop, {}), _jsx(Header, {}), _jsx("main", { className: "min-h-screen pt-8 md:pt-12 lg:pt-16 pb-16", children: _jsx(Suspense, { fallback: _jsx("div", { className: "px-6 py-10 text-sm text-gray-600", children: "Loading\u2026" }), children: _jsx(Outlet, {}) }) }), _jsx(FloatingAssistant, {}), _jsx(BackToTopButton, {})] }));
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        path: '',
                        element: _jsx(WorksheetGeneratorPage, {}),
                    },
                ],
            },
            {
