    ...
    phonics: {
      ...
      levels: {
        foundations: {
          ...
          ageRange: { min: 3, max: 7, label: 'Ages 3–7' },
          lessonCount: 31,
        },
        early: {
          ...
          label: 'Early Phonics',
          ageRange: { min: 4, max: 8, label: 'Ages 4–8' },
          lessonCount: 40,
        },
        advanced: {
          ...
          ageRange: { min: 6, max: 12, label: 'Ages 6–12' },
          lessonCount: 30,
        },
      },
    ...
    grammar: {
      ...
      levels: {
        beginner: {
          ...
          ageRange: { min: 5, max: 10, label: 'Ages 5–10' },
          lessonCount: 36,
        },
        advanced: {
          ...
          ageRange: { min: 8, max: 12, label: 'Ages 8–12' },
          lessonCount: 36,
        },
      },
      totalLessonCount: 72,
