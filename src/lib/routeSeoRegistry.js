...
import { GRAMMAR_PROGRAMMATIC_RESOURCE_SEO } from './grammarProgrammaticRegistry.js';
...
export const ROUTE_SEO_REGISTRY = {
  ...
  '/learning-partner': {
    ...
    description:
      'Learn how Tiny Steps Learning Partners support parents, teachers, and children with onboarding, scheduling, and steady progress.',
  ...
  '/terms-and-conditions': {
    ...
    description:
      'Review the Tiny Steps Learning terms covering enrolment, payments, scheduling, conduct, intellectual property, liability, and governing law.',
  ...
  '/refund-guarantee': {
    ...
    description:
      'Read the Tiny Steps Learning refund and guarantee policy covering assessments, 7-day refunds, unused classes, mentor fit, and refund processing timelines.',
  ...
  '/parents/getting-started': {
    ...
    description:
      'A step-by-step guide for parents to get started with Tiny Steps Learning. Enrollment, first class, and what to expect.',
  ...
  '/parents/scheduling': {
    ...
    description:
      "Tips for scheduling and managing your child's online English classes with flexibility and consistency.",
  ...
  '/parents/tracking-progress': {
    ...
    description:
      "Understand how Tiny Steps Learning helps you track your child's English learning progress and celebrate milestones.",
  ...
  '/parents/helping-with-homework': {
    ...
    description:
      "Tips and strategies for parents to support your child's English practice and homework between classes.",
  ...
  '/parents/phonics-mission': {
    ...
    description:
      "A parent's guide to the Phonics Mission program. How to help your child master phonics through engaging practice.",
  ...
  '/parents/reading-at-home': {
    ...
    description:
      "Strategies for parents to encourage reading at home and support your child's literacy development.",
  ...
  '/phonics-apps-for-preschoolers-india': {
    ...
    description:
      'Parent-friendly guide to phonics apps for preschoolers in India with screen-time advice, app selection criteria, and a simple home routine.',
  ...
  '/phonics-games-for-preschoolers': {
    ...
    description:
      'Simple phonics games for preschoolers that build letter-sound recognition, blending confidence, and short daily practice habits.',
  ...
  '/phonics-fees-india': {
    ...
    description:
      'Compare 2026 live-online phonics class fees in India with verified public 1:1 and group prices, provider sources, and practical online-vs-offline cost factors.',
