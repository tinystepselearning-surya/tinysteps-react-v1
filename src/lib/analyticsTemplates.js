...
export const parentInsights = {
    weeklyParentEmail: {
        ...
        content: {
            topAchievement: '🎉 Mastered CVC Words! John can now spell cat, dog, sit, run, pig with 95% accuracy!',
            skillFocus: "This week: Blending sounds\nJohn is learning to blend sounds together (/c/ /a/ /t/ = 'cat'). This is important for reading!",
...
Why: Spaced practice helps brain remember better!`,
            areasToWork: 'John is still working on pronunciation of /r/ sound. Practice "r" words: red, run, rain, roof',
