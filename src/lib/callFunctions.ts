...
const FUNCTION_REGION_OVERRIDES: Record<string, string> = {
  ...
  adminLinkSchoolUser: 'asia-south1',
  adminUnlinkSchoolUser: 'asia-south1',
  schoolGetProgrammeSnapshot: 'asia-south1',
  schoolCreateAcademicYear: 'asia-south1',
  schoolSetCurrentAcademicYear: 'asia-south1',
  schoolUpsertGrade: 'asia-south1',
  schoolSetGradeStatus: 'asia-south1',
  schoolUpsertSection: 'asia-south1',
  schoolSetSectionStatus: 'asia-south1',
  schoolUpsertTeacher: 'asia-south1',
  schoolSetTeacherStatus: 'asia-south1',
  schoolUpdateCurriculumProgress: 'asia-south1',
  schoolUpdateTeacherTraining: 'asia-south1',
  schoolCreateReview: 'asia-south1',
  schoolRecordAssessmentSummary: 'asia-south1',
  ...
  reconcileMyUnreadMessageCount: 'asia-south1',
  ...
  bootstrapParentCourseProgress: 'asia-south1',
