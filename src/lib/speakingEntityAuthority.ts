...
export const SPEAKING_ENTITY_AUTHORITY_REVISION = '2026-09-19-b11-v1';
...
if (FOUNDER_PUBLIC_PROFILES.length !== 1 || FOUNDER_PUBLIC_PROFILE_URLS.length !== 1) {
  throw new Error('Brick 11 currently expects one verified founder public profile.');
}
