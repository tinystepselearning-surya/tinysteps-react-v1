...
async function main() {
  ...
  await fs.rm(path.join(ROOT, 'scripts/brick4-rebase-repair-once.mjs'));
  await fs.rm(path.join(ROOT, '.github/workflows/brick4-rebase-repair-once.yml'));
  console.log('Rebased Brick 4 repairs applied; one-time repair files removed.');
}
