/*
 * seeds teacherLessons collection in Firestore emulator (CommonJS)
 * Usage (emulator):
 * FIRESTORE_EMULATOR_HOST=127.0.0.1:8085 GOOGLE_CLOUD_PROJECT=tinysteps-react-v1 node scripts/seed-teacher-lessons.cjs
 */
