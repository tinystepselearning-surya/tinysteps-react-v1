...
const pagePath = 'src/pages/public/PhonicsFeesIndiaPage.tsx';
const registryPath = 'src/lib/routeSeoRegistry.js';

const page = `import { useEffect } from 'react';
