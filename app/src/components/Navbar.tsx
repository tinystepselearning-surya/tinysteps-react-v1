...
const courseLinks = [
  ...
  { label: "Grammar", href: "/courses/grammar" },
          ...
          <nav className="mx-auto max-w-7xl px-4 py-3 grid gap-2 text-sm">
            ...
            <details className="group">
              ...
              <div className="mt-2 grid">
                {courseLinks.map((c) => (
                  <a key={c.label} href={c.href} className="text-gray-700 py-2 border-b">
                    {c.label}
                  </a>
                ))}
              </div>
            ...
            <a href="/curriculum" className="text-gray-700 py-2 border-b" onClick={() => setOpen(false)}>
              Curriculum
            </a>
            <a href="/blog" className="text-gray-700 py-2 border-b" onClick={() => setOpen(false)}>
              Blog
            </a>
            <a href="/faq" className="text-gray-700 py-2 border-b" onClick={() => setOpen(false)}>
              FAQ
            </a>
